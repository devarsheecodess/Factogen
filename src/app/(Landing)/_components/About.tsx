            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-16 shadow-2xl border border-gray-100 hover:shadow-3xl transition-all duration-500">
              <p className="text-xl leading-relaxed text-gray-700 text-center space-y-8">
                ...
                <span className="block">
                  ...
                  using a blend of citation metrics, writing quality signals,
                  and model-driven fact-checking to help you assess the
                  reliability of the paper before trusting its claims. It
                  highlights weak arguments, flags inconsistencies, and brings
                  transparency to academic content.
                </span>
